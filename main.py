...
def initButtons(font, RUTA):
    ...
    text_lines = [
        "Al instalar los mods por separado, se creará ",
        "una carpeta \"Server Minecraft 2024\" ",
        "en la ruta especificada o por defecto, porque",
        "el juego se lanza desde ahí por lo que no ",
        "recomiendo que modifiquéis ningun fichero.",
        "",
        "",
        "Si todo va bien, al abrir el juego estará la instalación ",
        "\"Server Minecraft 2024\" para darle ",
